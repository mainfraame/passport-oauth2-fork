...
describe('OAuth2Strategy - session state', function () {
    ...
    describe('issuing authorization request', function () {
      ...
      describe('that redirects to service provider', function () {
        ...
        it('should save state in session', function () {
          ...
          expect(request.session['oauth2:www.example.com'].state).toHaveLength(
            24
          );
          expect(request.session['oauth2:www.example.com'].state).toEqual(
            u.query.state
          );
        });
    ...
    describe('issuing authorization request', function () {
      describe('that redirects to service provider', function () {
        ...
        it('should save state in session', function () {
          ...
          expect(request.session['oauth2:example'].state).toHaveLength(24);
          expect(request.session['oauth2:example'].state).toEqual(
            u.query.state
          );
        });
      }); // that redirects to service provider
